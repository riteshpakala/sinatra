...
import { STLLoader } from './three/jsm/loaders/STLLoader'
import { ThreeMFLoader } from './three/jsm/loaders/3MFLoader'
...
class ModelViewer extends Component {
  constructor(props) {
    ...
    this.calculateVH = this.calculateVH.bind(this);
  }
  ...
  componentDidMount() {
    ...
    this.renderer.setClearColor(this.props.backgroundColor, 0.42);//(this.props.backgroundColor)
    ...
    // ADD CONTROL
    this.control = new OrbitControls( this.camera, this.renderer.domElement, this.props.clickController )
  ...
  updateCanvasSize = () => {
    ...
    const aspectRatio = ((containerHeight/containerWidth)*100).toString()+"%";
    document.querySelector('#canvasContainer').paddingBottom = aspectRatio;
